...
from players.models import NBA_TEAMS
...
class StatLine(models.Model):
    ...
    def __unicode__(self):
        return "{0} - {1}: {2}pts {3}rbs {4}asts {5}blks {6}stls".format(self.player, 
        	self.game, self.pts, self.rbs, self.asts, self.blks, self.stls)
